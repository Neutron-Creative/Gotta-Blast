		...
		[
			...
			AssetLoader::LOCALIZE => [
				...
				AssetLoader::LOCALIZEDATA => [
					'mainMenu'         => '<span class="hamburger"></span><span class="screen-reader-text">' . __( 'Menu', 'gotta-blast' ) . '</span>',
					'subMenu'          => __( 'Sub Menu', 'gotta-blast' ),
					'menuIconClass'    => null,
...
$core_customizer = [
	Customizer::SECTIONS => [
		[
			...
			Customizer::TITLE => __( 'Single Posts', 'gotta-blast' ),
	...
	Customizer::FIELDS   => [
		[
			...
			Customizer::LABEL         => __( 'Display featured image?', 'gotta-blast' ),
	...
	Hooks::ADD    => [
		...
		[
			...
			Hooks::CALLBACK => function() {
				echo '<div class="nc-footer"><div class="wrap">Copyright ©' . date("Y") . ' Neutron Creative Inc. - All rights reserved</div></div>';
			}
		],
		[
		...
		[
			...
			Hooks::CALLBACK => function ( $output, $original_output ) {
				if ( 'open' == $original_output ) {
					...
					$backtotop = '<a href="#" rel="nofollow" class="backtotop">' . __( 'Return to top', 'gotta-blast' ) . '</a>';
...
$core_layouts = [
	PageLayouts::REGISTER   => [
		[
			'id'    => 'center-content',
			'label' => __( 'Center Content', 'gotta-blast' ),
...
$core_theme_support = [
	ThemeSupport::ADD => [
		...
		'genesis-menus'               => [
			'primary'   => __( 'Header Menu', 'gotta-blast' ),
			'secondary' => __( 'After Header Menu', 'gotta-blast' ),
		],
...
$core_widget_areas = [
	WidgetArea::REGISTER   => [
		[
			...
			WidgetArea::NAME         => __( 'Front Page 1', 'gotta-blast' ),
			WidgetArea::DESCRIPTION  => __( 'Front Page 1 widget area.', 'gotta-blast' ),
		...
		[
			...
			WidgetArea::NAME        => __( 'Front Page 2', 'gotta-blast' ),
			WidgetArea::DESCRIPTION => __( 'Front Page 2 widget area.', 'gotta-blast' ),
			WidgetArea::LOCATION    => 'genesis_loop',
			WidgetArea::CONDITIONAL => function () {
				return is_front_page();
			},
		...
		[
			...
			WidgetArea::NAME        => __( 'Front Page 3', 'gotta-blast' ),
			WidgetArea::DESCRIPTION => __( 'Front Page 3 widget area.', 'gotta-blast' ),
			WidgetArea::LOCATION    => 'genesis_loop',
			WidgetArea::CONDITIONAL => function () {
				return is_front_page();
			},
